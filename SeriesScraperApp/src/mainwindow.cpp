...
void MainWindow::setUpGUI()
{
    ...
    // Add icons
    this->setWindowIcon(QIcon(":/ui_icons/logo.png"));
    settingsAction->setIcon(QIcon(":/ui_icons/settings.png"));
    aboutAction->setIcon(QIcon(":/ui_icons/about.png"));
    savePosterAction->setIcon(QIcon(":/ui_icons/save.png"));
    undoRenameAction->setIcon(QIcon(":/ui_icons/undo.png"));
    openDirectoryAction->setIcon(QIcon(":/ui_icons/folder.png"));
    switchDirectorySelectorAction->setIcon(QIcon(":/ui_icons/notepad.png"));
    reloadDirectoryAction->setIcon(QIcon(":/ui_icons/update.png"));
    fullScreenAction->setIcon(QIcon(":/ui_icons/fullscreen.png"));
...
void MainWindow::setUpTable()
{
    ...
    imageBackground = QString("background-image: url(:/ui_icons/logo.png); ")
...
void MainWindow::setSeriesAvailableStatus(bool status, bool isEmpty)
{
    ...
    else if (status)
    {
        ...
        ui->correctSeriesLabel->setPixmap(QPixmap(":/ui_icons/check-20.png"));
        hideSeriesLoadingAnimation();
    }
    else
    {
        ui->seriesLineEdit->setStyleSheet(colorRed);
        ui->correctSeriesLabel->setPixmap(QPixmap(":/ui_icons/error-20.png"));
        hideSeriesLoadingAnimation();
    }
}
...
void MainWindow::setPathCorrectStatus(bool status, bool isEmpty)
{
    ...
    else if (status)
    {
        ...
        ui->correctPathLabel->setPixmap(QPixmap(":/ui_icons/check-20.png"));
    }
    else
    {
        ui->directPathInputLineEdit->setStyleSheet(colorRed);
        ui->correctPathLabel->setPixmap(QPixmap(":/ui_icons/error-20.png"));
    }
}
...
void MainWindow::updateDirectoryWidget(std::vector<QStringList> pathStructure, bool containsRoot, QString path)
{
    ...
    {
        directoryEntriesMenu->addAction(QIcon(":/ui_icons/folder.png"), pathStructure.at(0).at(i));
    }
    ...
    for (std::size_t i = 0; i < (pathStructure.size() - 2); i++)
    {
        for (std::size_t j = 0; j < static_cast<std::size_t>(pathStructure.at(i + 1).size()); j++)
        {
            ...
            {
                pathStructureComboBoxList[i]->addItem(QIcon(":/ui_icons/folder.png"), pathStructure.at(i + 1).at(j));
            }
        }
...
void MainWindow::setStatusMessage(QString message, StatusMessageType type)
{
    ...
    {
        labelText = "<img src=:/ui_icons/error.png> ";
        break;
    }
    case StatusMessageType::success:
    {
        labelText = "<img src=:/ui_icons/check.png> ";
        break;
    }
...
void MainWindow::notify(Message &msg)
{
    ...
    case Message::Type::controller_setSeriesInfo_view:
    {
        ...
        {
            seriesImage.load(":/ui_icons/default_poster.jpg");
        }
