...
#include "../SeriesScraperApp/src/keypresseater.h"
...
void KeyPressEater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        KeyPressEater *_t = static_cast<KeyPressEater *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (KeyPressEater::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyPressEater::keyPressed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject KeyPressEater::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_KeyPressEater.data,
      qt_meta_data_KeyPressEater,  qt_static_metacall, nullptr, nullptr}
};
